...
{
    public static class CreateCategoryFromHomeValidation
    {
        public static bool Valid(this ModelStateDictionary modelState, HomeViewModel? model, UnitOfWork unitOfWork)
        {
            if (model == null)
                return false;
